...
class RequestBody:
    ...
    def to_dict(self) -> dict:
        ...
        return dict(request_id=self.request_id, source=source, target=target, path=path_list, cost=self.cost, visited_regions=self.visited_regions, last=self.source.id)
